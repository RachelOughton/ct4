...
```{r, eval=F, echo=T}
install.packages(c("HSAUR", "HSAUR3", "pROC", "survival", "ggsurvfit", "car"))
```
...
The packages we need for this section are `survival`, `ggsurvfit` and `ggfortify`, so load those now.
