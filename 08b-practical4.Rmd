...
In this practical we'll focus on the analysis of binary and survival data. We'll make use of several packages. Installing them all now should hopefully prevent it from disrupting your flow! We'll load them as we go along.
...
If you have time, you could now combine the work we've done in this practical and the previous one to implement power simulation for a survival outcome trial - recall that we didn't cover an analytical method for this in lectures.
