...
where $\mathbf{R}^2_j$ is the squared multiple correlation for the regression of $x_j$ on all the other covariates. The **variance inflation factor** is given by
