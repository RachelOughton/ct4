...
where $\bar{x}_t,\,s_t$ are the sample mean and SD at time $t$. The standardised spaghetti plot for the `epilepsy` data is shown in Figure \@ref(fig:standepi)

```{r standepi, fig.cap = "Standardised spaghetti plot for the epilepsy data."}
epi_stand = epilepsy
