...
:::{.exercise}
Fit an ANCOVA model to the polyps data, and interpret your results. If you aren't familiar with the function `lm`, it might be a good idea to look at the solutions.
...
We can find the variance inflation factor using the `vif` function from the package `car`
