...
\pandocbounded{\includegraphics[keepaspectratio]{CT4H_notes_files/figure-latex/unnamed-chunk-63-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{CT4H_notes_files/figure-latex/unnamed-chunk-73-1.pdf}}
\caption{\label{fig:unnamed-chunk-73}Confidence intervals for fixed effects for the two fitted models.}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-74}Confidence intervals for model with same gradient for all participants (left) and for varying gradient (right).}
\end{figure}
