...
\begin{example}
First we'll check the \texttt{ovarian} dataset, split by treatment group.

\includegraphics{CT4H_notes_files/figure-latex/unnamed-chunk-64-1.pdf}

As before, there isn't really enough data to tell whether the assumption is violated.

\includegraphics{CT4H_notes_files/figure-latex/unnamed-chunk-65-1.pdf}

\includegraphics{CT4H_notes_files/figure-latex/unnamed-chunk-66-1.pdf}
...
Firstly we can check the proportional hazards assumption for the categorical covariates:
...
\includegraphics{CT4H_notes_files/figure-latex/unnamed-chunk-67-1.pdf}
...
and check the Schoenfeld residuals for \texttt{karno}
...
\includegraphics{CT4H_notes_files/figure-latex/unnamed-chunk-69-1.pdf}

Although these don't look terrible, it appears there is a slight trend with time, and indeed the p-value shows a significant deviation from proportional hazards.
\end{example}
