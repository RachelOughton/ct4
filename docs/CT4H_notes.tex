...
\NormalTok{df\_indo}\SpecialCharTok{$}\NormalTok{logodds }\OtherTok{=} \FunctionTok{predict}\NormalTok{(glm\_indo, }\AttributeTok{newdata=}\NormalTok{df\_indo)}
