...
survfit(Surv(time = ovarian$futime, event = ovarian$fustat) ~ 1, data=ov_err2) %>%
  ggsurvfit() +
...
The Kaplan-Meier estimate may seem a bit disatisfying, since it stops changing at $t=638$ with a probabiilty of $0.497$. However, this is really (in a non-parametric setting) all we can say with the data available; 10 of the participants were definitely still alive at $t=638$, and some of the other censored participants may also have been.
