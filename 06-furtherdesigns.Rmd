...
```{r ssapp}
if(is_html_output()){
  knitr::include_app(url = "https://racheloughton.shinyapps.io/sample_size/")
} else {
...
```{r lmerplot1, echo=T, fig.cap = "CIs for the model coefficients", fig.height=1.4}
...
if(knitr::is_html_output()){
  ...
  knitr::include_graphics("images/raneffmodels.png", dpi=400) 
}
```
